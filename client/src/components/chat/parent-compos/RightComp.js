  ...
  return (
    <div className="right-comp">
      ...
      <div className="chat-head">
        <div>
          ...
          <span
            ...
            style={{ background: image ? "black" : avatar }}
          >
            {image ? (
              <img
        ...
        <div className="menu-icon" onClick={toggleDropDown}>
          <i
            ...
            style={{ opacity: open ? "0" : "100" }}
          ></i>
          {open && (
            <div className="dropdown">
              <div
                className="dropdown-option"
                onClick={() => dispatch(deleteWholeChat(_id))}
              >
                Delete chat
              </div>
              {!isBlockedByUser && (
      ...
      <div className="chat-section" id="chat-container">
        {messageStore[_id] && messageStore[_id].length > 0 ? (
          messageStore[_id].map((obj) => {
            return (
              <PhotoProvider>
                {obj.msg ? (
                  <div
                    ...
                    key={obj.msgId}
                    className={`msg-box ${
                      obj.id === userId ? "msg-right" : "msg-left"
                    }`}
                  >
                    {obj.msg}
                    <span className="time">
      ...
      <div className="msg-sender">
        {isBlocked || isBlockedByUser ? (
          ...
          <>
            ...
            <button
              className="btn-send"
              disabled={text.length <= 0 || !text.trim().length}
              onClick={sendMsg}
            >
              <img
                src="https://www.kodingwife.com/demos/ichat/dark-version/img/send1.svg"
                alt=""
              />
            </button>
          </>
